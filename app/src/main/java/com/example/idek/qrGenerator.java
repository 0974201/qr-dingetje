...
public class qrGenerator {
    ...
    //ze hebben de code v/d test app uit de zxing repo verwijderd. cool.
    ...
    private int rood = Color.rgb(204, 1, 51); //rood.
    ...
    public Bitmap qrGen(String geweldigeTekst) throws WriterException { // < hoe had ik met mijn slaperige kop de static gemist hier??
        ...
        try {
            ...
            Bitmap bitmap = Bitmap.createBitmap(zooi, qrWH, qrWH, Bitmap.Config.ARGB_8888); //qr code > bitmap zodat het gezien kan worden
            //bitmap.setPixels(zooi, 0, qrWH, 0, 0, qrWH, qrWH); //dit in comments gezet aangezien createBitmap de array ook pakt.
